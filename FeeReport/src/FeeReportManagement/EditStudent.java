           ...
           public void mouseClicked(MouseEvent arg0) {
              try{
                  ...
                  while(rest1.next()){
                      ...
                      tf11.setText(rest1.getString("mobile"));
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(e.getSource()==bt1){
            try {
                ...
                String q = "update add_student set name='"+name+"',email='"+email+"',course='"+course+"',fee='"+fee+"',paid='"+paid+"',due='"+due+"',address='"+address+"',city='"+city+"',state='"+state+"' ,country='"+country+"',mobile='"+contact+"' where rollno='"+roll+"'";
                ...
                if(aa==1){
                    ...
                    JOptionPane.showMessageDialog(null,"please !fill your all details carefully");
                    // this.setVisible(false);
                }
            }
            catch(Exception ee){
