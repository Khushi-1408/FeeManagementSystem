...
public class AddAccountant extends JFrame implements ActionListener
{
    ...
    AddAccountant()
    {
        ...
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("FeeReportManagement/icons/icon.jpeg"));
  ...
  if(e.getSource()==bt1)
  {
      ...
      try{
          ...
          if(a==1){
              ...
              JOptionPane.showMessageDialog(null,"Your data is  not successfully inserted");
